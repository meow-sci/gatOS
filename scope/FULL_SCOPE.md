...
two reproduced method bodies); and the **FX editors** (2026-08-01) added the new `Game/Ksa/Fx/` set (24,
the largest single addition — seven of them reflective handles, catalogued in
[`ksa-runtime-coupling.md#fx-accessors`](ksa-runtime-coupling.md#fx-accessors)). So the only remaining un-anchored KSA touch-points are the two
