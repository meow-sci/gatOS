    ...
    internal const string Document =
        """
        {
          ...
          "paths": {
            ...
            "/paint/texture/files": { "get": { "summary": "Uploaded clutter-texture images (name, bytes, kind, version, ready); /v1/paint/textures/... is an alias", "responses": { "200": { "description": "image list" }, "404": { "description": "custom clutter textures disabled" } } } },
            "/paint/texture/file/{name}": {
              ...
              "delete": { "summary": "Evict an uploaded image (any binding using it is unbound first)", "parameters": [{ "name": "name", "in": "path", "required": true, "schema": { "type": "string" } }], "responses": { "200": { "description": "{outcome:ok}" }, "404": { "description": "ENOENT" } } }
            },
            "/command": {
              "post": {
