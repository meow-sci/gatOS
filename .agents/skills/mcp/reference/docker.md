...
resource: "https://github.com/modelcontextprotocol/csharp-sdk/blob/main/docs/concepts/deployment/docker.md"
...
Streamable HTTP is the recommended transport for containerized MCP servers. The legacy SSE endpoints (`/mcp/sse` and `/mcp/message`) are not mapped by default, and the option to enable them is obsolete. See [Transports](transports.md) for details.
