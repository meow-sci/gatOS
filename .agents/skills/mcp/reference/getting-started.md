...
resource: "https://github.com/modelcontextprotocol/csharp-sdk/blob/main/docs/concepts/getting-started.md"
...
For the full HTTP security examples, including `AllowedHosts` and restrictive CORS on `MapMcp`, see [Streamable HTTP transport](transports.md#browser-cross-origin-access).
