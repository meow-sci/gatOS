...
title: "List Of Diagnostics"
description: "Local copy of the C# MCP SDK documentation page List Of Diagnostics."
resource: "https://github.com/modelcontextprotocol/csharp-sdk/blob/main/docs/list-of-diagnostics.md"
...
| `MCP9004` | In place | `ModelContextProtocol.AspNetCore.HttpServerTransportOptions.EnableLegacySse` opts into the legacy SSE transport which has no built-in HTTP-level backpressure. Use Streamable HTTP instead. See [Stateless and Stateful — Legacy SSE transport](stateless.md#legacy-sse-transport) for details. |
