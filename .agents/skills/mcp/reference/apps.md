...
resource: "https://github.com/modelcontextprotocol/csharp-sdk/blob/main/docs/concepts/apps/apps.md"
...
The `ModelContextProtocol.Extensions.Apps.McpApps` class provides constants for protocol values:
