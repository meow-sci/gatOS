...
resource: "https://github.com/modelcontextprotocol/csharp-sdk/blob/main/docs/concepts/identity/identity.md"
...
For more details on authorization filters and their execution order, see [Filters](filters.md).
...
For more details, including important caveats about stale `HttpContext` with the legacy SSE transport, see [HTTP Context](httpcontext.md).
