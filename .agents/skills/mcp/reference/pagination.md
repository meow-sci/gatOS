...
resource: "https://github.com/modelcontextprotocol/csharp-sdk/blob/main/docs/concepts/pagination/pagination.md"
...
The convenience methods on `ModelContextProtocol.Client.McpClient` handle pagination automatically, fetching all pages and returning the complete list:
