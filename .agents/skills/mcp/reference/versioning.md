...
resource: "https://github.com/modelcontextprotocol/csharp-sdk/blob/main/docs/versioning.md"
...
[`Tasks`](tasks.md) extension replaces the experimental Tasks implementation from v1.3.0 and
