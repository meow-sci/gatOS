...
- HTTP, MQTT, and MCP each expose the same listener-setting pair in flat TOML:
  `*_bind_host` (default `127.0.0.1`, IP literals only) and `*_preferred_port` (existing defaults
