...
hero:
  tagline: A Kitten Space Agency game integrated Linux OS
  image:
    file: ../../assets/gatos-banner-400.webp
  actions:
    - text: Get Started
      link: /gatOS/guides/get-started/
      icon: right-arrow
    - text: Browse the gatOS docs
      link: /gatOS/reference/
      icon: external
      variant: minimal
---
