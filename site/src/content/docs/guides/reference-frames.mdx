...
description: A plain-language tour of the coordinate frames Kitten Space Agency uses to describe where things are and which way they point, plus why CCI is where your gatOS programs live.
sidebar:
